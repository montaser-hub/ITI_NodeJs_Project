...
//   const category = await findById(req.params.id, next);
//     if (!category) return next(new AppError("Category not found", 404));
...
// const category = await findById(req.params.id, next);
//     if (!category) return next(new AppError("Category not found", 404));  const updatedCategory = await categoryModel.findByIdAndUpdate(
//     req.params.id,
//     req.body,
